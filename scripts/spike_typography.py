...
SAMPLES: list[tuple[str, dict[str, Any]]] = [
    ...
    ("compliant_small",
     {"warning_header_bold": True, "warning_body_bold": False, "warning_scale": 0.7}),
    ("body_bold_small",
     {"warning_header_bold": True, "warning_body_bold": True, "warning_scale": 0.7}),
    ("compliant_tiny",
     {"warning_header_bold": True, "warning_body_bold": False, "warning_scale": 0.55}),
    ("body_bold_tiny",
     {"warning_header_bold": True, "warning_body_bold": True, "warning_scale": 0.55}),
    ("compliant_large",
     {"warning_header_bold": True, "warning_body_bold": False, "warning_scale": 1.3}),
    ("title_case_header",
     {"warning_header_bold": True, "warning_body_bold": False,
